            ...
            <div id="top" data-area="subnavigation">
               <div class="center-wrap">
                  ...
                  <div class="moduletable  curconverter">
					 ...
					 <br>
                        <form method="post" class="conver-form1" name="currency_converter" action="updatecurrency" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           <div class="amount-label"><label data-for="amount">Amount</label></div>
                           <div class="amount-block"><input placeholder="1" value="1" class="amount" type="text" name="abouttext"></div>
                           <div class="select-block">
                              <div>
                                 <label data-for="from">From:</label>
                                 <div class="flags select from" id="from_input" onclick="myFunction(this)">
                                    <div class="selected-item" data-value="USD"><span>
                                       USD - US Dollar</span><input class="filter-input" value="">
                                    </div>
                                    ...
                                    <div class="select-options mCustomScrollbar _mCS_1">
                                       <div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: 366px;" tabindex="0">
                                          <div id="mCSB_1_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                                             <div class="optiont-title">Top Currencies</div>
                                             <div data-value="USD" class="b-lazy select-option selected b-loaded" style="background-image: url(&quot;../../images/flags/45/USD.png&quot;);">USD - US Dollar</div>
                                             <div data-value="EUR" class="b-lazy select-option b-loaded" style="background-image: url(&quot;../../images/flags/45/EUR.png&quot;);">EUR - Euro</div>
                                             <div data-value="GBP" class="b-lazy select-option b-loaded" style="background-image: url(&quot;../../images/flags/45/GBP.png&quot;);">GBP - Pound Sterling</div>
                                             ...
                                             <div class="optiont-title">All Currencies</div>
                                          ...
                                          <div id="mCSB_1_scrollbar_vertical" class="mCSB_scrollTools mCSB_1_scrollbar mCS-light mCSB_scrollTools_vertical" style="display: block;">
                                             ...
                                             <div class="mCSB_draggerContainer">
                                                <div id="mCSB_1_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 30px; display: block; height: 17px; max-height: 339px; top: 0px;" oncontextmenu="return false;">
                              ...
                              <div class="to">
                                 <label data-for="to">To:</label>
                                 <div class="flags select to" id="to_input" onclick="myFunction(this)">
                                    <div class="selected-item" data-value="EUR"><span>EUR - Euro</span><input class="filter-input" value=""></div>
                                    <select name="currto">
                                       <option value="AED">AED - Emirati Dirham</option>
                                       <option value="AFN">AFN - Afghan Afghani</option>
                                       <option value="ALL">ALL - Albanian Lek</option>
                                    ...
                                    <div class="select-options mCustomScrollbar _mCS_2">
                                       <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: 366px;" tabindex="0">
                                          <div id="mCSB_2_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                                             <div class="optiont-title">Top Currencies</div>
                                             <div data-value="USD" class="b-lazy select-option b-loaded" style="background-image: url(&quot;../../images/flags/45/USD.png&quot;);">USD - US Dollar</div>
                                             <div data-value="EUR" class="b-lazy select-option selected b-loaded" style="background-image: url(&quot;../../images/flags/45/EUR.png&quot;);">EUR - Euro</div>
                                             <div data-value="GBP" class="b-lazy select-option b-loaded" style="background-image: url(&quot;../../images/flags/45/GBP.png&quot;);">GBP - Pound Sterling</div>
                                             <div data-value="CAD" class="b-lazy select-option" data-src="../../images/flags/45/CAD.png">CAD - Canadian Dollar</div>
                                             <div data-value="CHF" class="b-lazy select-option" data-src="../../images/flags/45/CHF.png">CHF - Swiss Franc</div>
                                             <div data-value="AUD" class="b-lazy select-option" data-src="../../images/flags/45/AUD.png">AUD - Australian Dollar</div>
                                          ...
                                          <div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-light mCSB_scrollTools_vertical" style="display: block;">
                                             <a href="#" class="mCSB_buttonUp" oncontextmenu="return false;" style="display: block;"></a>
                                             <div class="mCSB_draggerContainer">
                                                <div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 30px; display: block; height: 17px; max-height: 339px; top: 0px;" oncontextmenu="return false;">
                                                   <div class="mCSB_dragger_bar" style="line-height: 30px;"></div>
                                                </div>
                                                <div class="mCSB_draggerRail"></div>
                                             </div>
...
.show-more {
   ...
   <table class="tbl_rate" width='100%'>
      <tr>
         <th></th>
         <?php
            if(empty($cros)||$cros==null){
