...
|
*/
//Route::get('{currency}', 'Cur_Controller@test');
...
Route::get('graphview', 'Cur_Controller@graphview');
Route::post('graphcurrency', 'Cur_Controller@graphcurrency');
Route::get('widget', 'Cur_Controller@widget');
Route::get('/', function () {
    return view('welcome');
});